...
<body class="">
    ...
    <br>
    <form method="POST" action="proses_tambah_writer.php" enctype="multipart/form-data">
        <section class="base">
            <div>
                <label>Nama Writer</label>
                <input type="text" name="nama_writer" autofocus="" required="" />
            </div>
            <div>
